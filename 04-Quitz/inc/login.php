...
<form class="login-card" action="inc/quitz.php" method="post">
    ...
    <div class="login-item"><label for="email">Почта</label><input type="text" name="email" id="email" placeholder="Почта" /></div>
    <div class="login-item"><label style="width:54.5%;"></label><button name="btn_log" type="submit">Start</button></div>
</form>
